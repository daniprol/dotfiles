...
" Remove extra whitespace when saving (THE PRIMEAGEN)
...
" Yank to unnamedplus clipboard
vmap <Leader>y "+y
" Bind <leader> =  to	<C-W><C-= >  (to set splits of equals size)
vmap <Leader>= <C-W><C-=>

" RG
" bind K to grep word under cursor
" The ! avoids open the file after grepping
...
" nnoremap <expr> OO 'm`' . v:count1 . 'O<Esc>``'
nnoremap <expr> <leader>j 'm`' . v:count1 . 'o<Esc>``'
nnoremap <expr> <leader>k 'm`' . v:count1 . 'O<Esc>``'
...
" Only works with spell checking on!
noremap <C-l> [sz=
...
nnoremap <silent> <leader>$ :call StripTrailingWhitespaces()<CR>
